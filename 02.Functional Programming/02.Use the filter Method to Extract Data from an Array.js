/*
ASSIGNMENT:
Functional Programming: Use the filter Method to Extract Data from an Array: Passed
...
var filteredList = watchList.filter(movie => parseInt(movie.imdbRating) >= 8).map(movie => ({ title: movie.Title, rating: movie.imdbRating }));
